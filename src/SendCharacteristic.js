...
module.exports = {
  registerWith: function (hap) {
    ...
    class SendCharacteristic extends Characteristic {
      constructor(botName, displayName, notifications, bot) {
        const characteristicUuid = uuid.generate(`${botName}:${displayName}`);
        super(displayName, characteristicUuid);
    ...
    Characteristic.SendCharacteristic = SendCharacteristic;
  }
};
